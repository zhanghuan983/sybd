<template>
  <view class="container">
    ...
    <view class="tab-content">
	 ...
	 <!-- 页面内容 -->
	         <view class="list-title">13、电力电缆线路</view>
	         <!-- 列表项 -->
	         <view class="list">
...
export default {
  ...
  data() {
    return {
	  ...
	  listItems: [
	          { text: '13.1 一般规定', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/vZEluYLGi1ynZDzGirbZng' },      //  { text: '5.1 同步发电机和调相机', url: '/pages/biaozhun/diandongji51' },
	          { text: '13.2 35kV及以下油纸绝缘电力电缆线路', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/y8BsAOsjjMs940UWxXANRA' },
			  { text: '13.3 66kV及以上自容式充油电缆线路', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/e90E8ThFdPQoNJHXAqbmkA' },
			  { text: '13.4 橡塑绝缘电力电缆线路', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/cem6H0EeDWN2PXNHW26-3w' },
			  { text: '13.5 接地、交叉互联系统', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/ZOACnx6pnvPaA0eYRrTE-Q' },
			  // 你可以根据需要添加更多列表项
	        ],
	  }
  },
