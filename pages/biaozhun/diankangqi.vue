<template>
  <view class="container">
    ...
    <view class="tab-content">
	 ...
	 <!-- 页面内容 -->
	         <view class="list-title">7、电抗器及消弧线圈</view>
	         <!-- 列表项 -->
	         <view class="list">
...
export default {
  ...
  data() {
    return {
	  ...
	  listItems: [
	          { text: '7.1 油浸式电抗器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/JQkxqYhv3hnM3woYcFMY-g' },      //  { text: '5.1 同步发电机和调相机', url: '/pages/biaozhun/diandongji51' },
	          { text: '7.2 干式电抗器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/w_GBrKezniKgl51SbDaMzA' },
	          { text: '7.3 消弧线圈', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/zwFpYDLIvzUBk3D7eeX5MA' },
	          { text: '7.4 判断电抗器故障时可供选用的试验项目见附录F', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/P3oNFrJi2yHgvqe6kQgItg' },
	          // 你可以根据需要添加更多列表项
	        ],
	  }
  },
