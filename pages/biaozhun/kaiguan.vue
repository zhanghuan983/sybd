<template>
  <view class="container">
    ...
    <view class="tab-content">
	 ...
	 <!-- 页面内容 -->
	         <view class="list-title">9、开关设备</view>
	         <!-- 列表项 -->
	         <view class="list">
...
export default {
  ...
  data() {
    return {
	  ...
	  previewLink: 'https://mp.weixin.qq.com/s/Vzi4kQCjlf5JaJDXXwr-XQ',
	  ...
	  listItems: [
	          { text: '9.1 气体绝缘金属封闭开关设备', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/AG9sSXeZpF-ul3Z28wgS5g' },      //  { text: '5.1 同步发电机和调相机', url: '/pages/biaozhun/diandongji51' },
	          { text: '9.2 SF6断路器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/XjCmDQeihwRiX8h0tNLddA' },
	          { text: '9.3 油断路器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/mMrRclccloe2d41vRnDozA' },
	          { text: '9.4 低压断路器和自动灭磁开关', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/-40xgCcOLDxsJOwKf_FAIQ' },
	          { text: '9.5 真空断路器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/PWJ3FCwx4yw1L4Hwc_JsMg' },
			  { text: '9.6 重合器(包括以油、真空及SF6气体为绝缘介质的各种12kV重合器)', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/aJYEQn-lHP4BqY7KYziWYA' },
			  { text: '9.7 分段器(仅限于12kV级)', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/1O8PsSKWBVe4TiknpVKbBA' },
			  { text: '9.8 负荷开关', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/atkWDtZQvWJb_KwCrT_KMA' },
			  { text: '9.9 隔离开关和接地开关', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/5_qf32GvFlX59ToO7zmeWQ' },
			  { text: '9.10 高压开关柜', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/HxPunNJnFpiokBCSfG9gNA' },
