<template>
  <view class="container">
    ...
    <view class="tab-content">
	 ...
	 <!-- 页面内容 -->
	         <view class="list-title">10、有载调压装置</view>
	         <!-- 列表项 -->
	         <view class="list">
...
export default {
  ...
  data() {
    return {
	  ...
	  listItems: [
	          { text: '10.1 有载调压装置的试验项目、周期和要求', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/BLXgMdiVi3EfvbxjTHktaA' },      //  { text: '5.1 同步发电机和调相机', url: '/pages/biaozhun/diandongji51' },
	          // 你可以根据需要添加更多列表项
	        ],
	  }
  },
