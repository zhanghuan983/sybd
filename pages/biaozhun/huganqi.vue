<template>
  <view class="container">
    ...
    <view class="tab-content">
	 ...
	 <!-- 页面内容 -->
	         <view class="list-title">8、互感器</view>
	         <!-- 列表项 -->
	         <view class="list">
...
export default {
  ...
  data() {
    return {
	  ...
	  listItems: [
	          { text: '8.1 电流互感器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/SOo0jYDhbNmCzbdjoLMwbQ' },      //  { text: '5.1 同步发电机和调相机', url: '/pages/biaozhun/diandongji51' },
	          { text: '8.2 电压互感器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/1aVgZh8xat7cxWKXP66IDw' },
	          { text: '8.3 三相组合互感器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/aAdaPoNrODbWpONRC4gpsA' },
