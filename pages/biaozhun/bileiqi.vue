<template>
  <view class="container">
    ...
    <view class="tab-content">
	 ...
	 <!-- 页面内容 -->
	         <view class="list-title">16、避雷器</view>
	         <!-- 列表项 -->
	         <view class="list">
...
export default {
  ...
  data() {
    return {
	  ...
	  previewLink: 'https://mp.weixin.qq.com/s/hsINskOnE4sv21QQ9uiEZQ',
	  ...
	  listItems: [
	          { text: '16.1 金属氧化物避雷器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/YP_zMlBNKhxTGTAB5tdZGw' },      //  { text: '5.1 同步发电机和调相机', url: '/pages/biaozhun/diandongji51' },
	          { text: '16.2 阀式避雷器', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/ZRAZhNp4R-hdUZ_H0oFpDA' },
