  ...
  <view class="container">
    ...
    <view class="tab-content">
      <view v-if="activeTab === 'tab1'" class="tab-pane" :style="{ transform: 'translateX(' + (activeTab === 'tab1' ? '0' : '100%') + ')' }">
        ...
        <!-- 页面内容 -->
        <view class="list-title">5、旋转电机</view>
        <!-- 列表项 -->
        <view class="list">
...
export default {
  ...
  data() {
    return {
      ...
      listItems: [
        { text: '5.1 同步发电机和调相机', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/DTR3GAgUFeK01Aey0T-rIA' },
        { text: '5.2 交流励磁机', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/BqdX5c8PxmwLb4_BHpZfag' },
        { text: '5.3 直流励磁机及动力类直流电动机', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/xB8g06yzbh0e-Pgv9K0_YA' },
        { text: '5.4 交流电动机', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/8rrfVLv2YTurvTOqxT1GuA' },
        // 你可以根据需要添加更多列表项
      ],
      videoAd: null
    };
