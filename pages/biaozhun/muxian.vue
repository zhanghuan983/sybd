<template>
  <view class="container">
    ...
    <view class="tab-content">
	 ...
	 <!-- 页面内容 -->
	         <view class="list-title">17、母线</view>
	         <!-- 列表项 -->
	         <view class="list">
...
export default {
  ...
  data() {
    return {
	  ...
	  previewLink: 'https://mp.weixin.qq.com/s/iS3QIiubmknI4RyCRDXx5w',
	  ...
	  listItems: [
	          { text: '17.1 封闭母线', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/T4RVXzSVhkoepCQujc3wCg' },      //  { text: '5.1 同步发电机和调相机', url: '/pages/biaozhun/diandongji51' },
	          { text: '17.2 一般母线', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/i9xh7F3g6dVcjnJvxJS1bw' },
