<template>
  <view class="container">
    ...
    <view class="tab-content">
	 ...
	 <!-- 页面内容 -->
	         <view class="list-title">12、绝缘子</view>
	         <!-- 列表项 -->
	         <view class="list">
...
export default {
  ...
  data() {
    return {
	  ...
	  listItems: [
	          { text: '12.1 瓷绝缘子', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/btQF4VbyMOq5LeIS2MTgGQ' },      //  { text: '5.1 同步发电机和调相机', url: '/pages/biaozhun/diandongji51' },
	          { text: '12.2 玻璃绝缘子', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/XMAGMA1J8LvTOLnBUC7sDg' },
			  { text: '12.3 复合绝缘子', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/7DrKvr5T-ItyasrQAtQ_ag' },
			  { text: '12.4 防污闪涂料', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/2E5p5okfRfX6D7I5Q9QGXQ' },
			  { text: '12.5 防污闪辅助伞裙', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/gkohv79QmOTbX0xauBbTSQ' },
			  // 你可以根据需要添加更多列表项
	        ],
	  }
  },
