<template>
  <view class="container">
    ...
    <view class="tab-content">
	 ...
	 <!-- 页面内容 -->
	         <view class="list-title">15、绝缘油和六氟化硫气体</view>
	         <!-- 列表项 -->
	         <view class="list">
...
export default {
  ...
  data() {
    return {
	  ...
	  previewLink: 'https://mp.weixin.qq.com/s/OQzGcXa6UsWwQJ_pUMGMaQ',
	  ...
	  listItems: [
	          { text: '15.1 变压器油', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/D5z-wGNSEm69R-FqK_74pQ' },      //  { text: '5.1 同步发电机和调相机', url: '/pages/biaozhun/diandongji51' },
	          { text: '15.2 断路器油', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/M0JkhEEFrjtFF_5ZqOguRA' },
			  { text: '15.3 六氟化硫气体', url: '/pages/preview/preview?url=https://mp.weixin.qq.com/s/_LNU5SP0Forg10bI5GSfnw' },
